...
let LinkedList2 = new linked(8);
LinkedList2.next = new linked(9);
LinkedList2.next.next = new linked(7);
LinkedList2.next.next.next = LinkedList.next.next.next;
...
//console.log(getIntersectionNode(LinkedList,LinkedList2));
...
var better = function (headA, headB) {
    let list1 = headA, list2 = headB;
    let n1 = 0, n2 = 0;
    while (list1 !== null) {
        n1++;
...
console.log(better(LinkedList, LinkedList2));
